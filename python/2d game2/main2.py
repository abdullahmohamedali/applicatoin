...
class Tree(pygame.sprite.Sprite):
	def __init__(self,pos,group):
		...
		self.image = pygame.image.load('assets2/tree.png').convert_alpha()
		self.rect = self.image.get_rect(topleft = pos)

class Player(pygame.sprite.Sprite):
	def __init__(self,pos,group):
		super().__init__(group)
		self.image = pygame.image.load('assets2/player.png').convert_alpha()
...
class CameraGroup(pygame.sprite.Group):
	def __init__(self):
		...
		# ground
		self.ground_surf = pygame.image.load('assets2/ground.png').convert_alpha()
